---
name: system-arch
description: Use when planning major architecture changes, evaluating architectural patterns or trade-offs, designing new system components, or refactoring existing architecture. Triggers on "should we use X pattern", "how should we structure Y", or system design questions.
---
...
**Skip for:** Code implementation (use code-implementation), code review (use code-reviewer), testing (use integration-test-validator)
